...
public class ReportActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    Button submit_btn;
    VideoView videoView;
    TextView recordSound_text, recordVideo_text, playVideo_text;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        radioButton3= (RadioButton) findViewById(R.id.activity_report_radiogroup_radio3);
        preferences = getSharedPreferences("reportMSG", Context.MODE_PRIVATE);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_report_btn:
                ...
                task = new ReportTask(editText.getText().toString(), n, item);
                task.execute();
                onSubmit(true);
...
//                System.out.println("22222222222222222222222222222" + radioLongClick);
//                if (radioLongClick){
//                    radioLongClick = false;
//                    System.out.println("33333333333333333333333333" + radioLongClick);
//                    break;
//                }
            ...
            case R.id.activity_report_radiogroup_radio1:
                radioButton1.setChecked(true);
                radioButton2.setChecked(false);
                break;

            case R.id.activity_report_radiogroup_radio2:
...
//    }
    ...
    class ReportTask extends AsyncTask<Void, Void, Boolean> {
        ...
        ReportTask(String text, String flftSn, MenuItem item) {
            this.text = text;
            this.flftSn = flftSn;
            this.item = item;
        }
        ...
        protected Boolean doInBackground(Void... voids) {
            ...
            for (String path : imagePaths) {
                ...
                if (imageFile.exists()) {
                    ...
                    String newPath = ReportActivity.this.getFilesDir().toString() + "/" + FileTools.getNewName(ReportActivity.this) + "." + end;
            ...
            if (NetConfig.handleReport(ReportActivity.this, flftSn + "", text, files)) {
        ...
        protected void onPostExecute(final Boolean success) {
            if (success){
//                ReportActivity.this.progressBar.setVisibility(View.GONE);
